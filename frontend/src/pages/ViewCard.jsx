...
function ViewCard() {
  ...
  let [bookingPopUp, setBookingPopUp] = useState(false); //p8

  // some usestate we use from listingContext.jsx //p7
  ...
  let [minDate, setMinDate] = useState(""); //p8
  ...
  //function to update listing in form //7
  const handleUpdateListing = async () => {
    setUpdating(true);
    try {
      //make form data object to append some value
      ...
      navigate("/"); //after form submission redirect to home page
      // to automatically empty form after submit
      setTitle("");
      setDescription("");
  ...
  // also make function to update function p7
  ...
  //function to delete listing in form //7
  ...
  return (
    <div className="w-[100%] h-[100vh] bg-[white] flex items-center justify-center gap-[10px] flex-col overflow-auto  relative mt-2">
      <div
