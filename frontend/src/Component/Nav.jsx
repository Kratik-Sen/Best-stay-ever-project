...
import logo from '../assets/best stay white.jpg'
...
//for handle category p-6
    let [cate,setCate]= useState()
    let {listingData,setListingData,setNewListData,newListData,
searchData,handleSearch,handleViewCard //all 3 p9
}=useContext(listingDataContext)
    let [input,setInput]=useState("") //p9
