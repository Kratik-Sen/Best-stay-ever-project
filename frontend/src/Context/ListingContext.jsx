...
function ListingContext({children}) {
    ...
    let [listingData,setListingData]=useState([])//6
    let [newListData,setNewListData]=useState([])//6
    let [cardDetails,setCardDetails]=useState(null)//7
      let [updating,setUpdating]=useState(false)//7
    let [deleting,setDeleting]=useState(false)//7
    let [searchData,setSearchData]=useState([])//9
    ...
    let {serverUrl} = useContext(authDataContext)
     ...
     formData.append("category",category)
        ...
        setAdding(false)
        console.log(result)//after form submission redirect to home page
...
// function for search functionality p 9
